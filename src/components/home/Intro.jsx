  ...
  return (
    <div className=' grid grid-cols-5 gap-5'>
      <div className=' col-span-2'>
        ...
        <h1 className=' font-bold text-[5.5rem] leading-[5.4rem] text-stone-800'>New issues are waiting to solve</h1>
        <p className=' text-stone-500 mb-6 mt-4'>search and solving your legal issue is now easier than ever just browse a your issue and contact the resource person.</p>
